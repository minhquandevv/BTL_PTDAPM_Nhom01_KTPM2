...
<body>
    <div class="custom-container-employee my-5" id="create-motel-container">
        <div class="d-flex ">
            ...
            <div class="ms-10 text-edit-pic w-100 fw-500 d-flex justify-content-between">Xe cắm trại/RV tại Half Moon Bay, California, Hoa Kỳ 
                <div></div>
                <div class="me-2">
                    <a href=""><img src="bootstrap/css/patterns/pen-icon.svg" class="icon-p" alt=""></a>
                    <a href=""><img src="bootstrap/css/patterns/trash.svg" class="icon-p" alt=""></a>
                </div>
            </div>
        </div>
            ...
            <table class="table custom-table-pic mt-4" id="create-homestay-table">
                <tbody >
                    <tr >
                        ...
                        <td class="custom-td">
                            <p class="text-dark text-content-edit-homestay fw-500 m-0">MP001</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="custom-td">
                            <p class="text-dark text-content-edit-homestay fw-500 m-0">Xe cắm trại</p>
                        </td>
                    </tr>
                    ...
                    <td>
                        <p class="text-dark text-content-edit-homestay fw-400">Khung cảnh lãng mạn riêng tư với tầm nhìn chưa từng có ra Bờ biển và Bãi biển Thái Bình Dương.
                             Chỗ ở sang trọng trong một Airstream hoàn toàn mới, gần Vịnh Half Moon và Santa Cruz.</p>
                    </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="custom-td">
                            <p class="text-dark text-content-edit-homestay fw-500 m-0">Trống</p>
                        </td>
                    </tr>
                    ...
                    <td class="custom-td">
                        <p class="text-dark text-content-edit-homestay fw-500 m-0">1.000.000VND</p>
                    </td>
                    </tr>
