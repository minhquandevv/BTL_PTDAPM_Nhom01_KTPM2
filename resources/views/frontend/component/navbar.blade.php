...
<nav class="navbar navbar-expand-lg " style="background-color:#FDE7FB; height:80px">
    <div class="container-fluid">
        <div class=" row collapse navbar-collapse " id="navbarSupportedContent">
            <<<<<<< HEAD <div class="d-flex col-3 justify-content-center">
            ...
            <div class="d-flex w-50 my-4">
                <div class="form-control me-2 border rounded rounded-pill" aria-label="Search" role="button">
                    ...
                    <div class="col-3">
                        <a href="/home" class="text-decoration-none text-dark">
                            <img class="card-img-top rounded-lg"
                                src=" https://img.upanh.tv/2024/02/27/Screenshot-2024-02-22-224735.png" alt="/"
                                style="width:141px;height:41px" />
                        </a>
                    </div>
                    <div class="col-6">
                        <div style="padding-left: 20%; padding-right: 20%">
                            <div class="input-group">
                                ...
                                <input type="search" class="custom-searchbar_input position-relative form-control"
                    ...
                    <div class="col-3 collapse navbar-collapse justify-content-evenly " id="navbarNav" role="">
                        <button type="button" class="btn btn-hover fs-3 fw-medium border-0 rounded-4"
                            aria-current="page" href="#" style="background-color:#FDE7FB;">Trang chủ</button>
                        <div class="dropdown border rounded rounded-pill ms-3 p-3 bg-white">
                            <div class="btn-menu btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-center border-1 rounded-4 position-absolute "
                                    ...
                                    <li><button class="dropdown-item fw-medium py-2 fs-3" type="button" href="">Đánh giá
                                            và phản
                                            hồi</button>
                                    </li>
                                    ...
                                    <li><button
                                            class="dropdown-item fw-medium border-bottom border-secondary-subtler py-2 fs-3"
                                            type="button" style="border-color:blueviolet">Danh sách yêu thích</button>
                                    </li>
                                    <li><button class="dropdown-item py-2 fs-3" type="button">Quản lí thông tin đặt
                                            phòng</button>
                                    </li>
                                    <li><button class="dropdown-item  border-bottom border-secondary-subtler py-2 fs-3"
                                            type="button" style="border-color:blueviolet">Quản lí thông tin cá
                                            nhân</button>
                                    </li>
                                    <li><button class="dropdown-item py-2 fs-3" type="button">Trung tâm hỗ trợ</button>
                                    </li>
                            ...
                            <div class="btn-user btn-group ">
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg-end border-1 rounded-4 position-absolute"
                                    ...
                                    <li><button class="dropdown-item fs-3 fw-medium py-2" type="button">Đăng kí</button>
                                    </li>
                                    <li><button
                                            class="dropdown-item fs-3 fw-medium border-bottom border-secondary-subtler py-2"
                                            type="button" style="border-color:blueviolet">Đăng nhập</button></li>
                                    <li><button class="dropdown-item fs-3 py-2" type="button">Trang chủ AirHome</button>
                                    </li>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start border-1 rounded-4"
                                            style="background-color:#FDE7FB; border-color:blueviolet">
                                            <li>
                                                <button class="dropdown-item fw-medium py-2" type="button" href="">Đánh
                                                    giá
                                                    và phản
                                                    hồi
                                                </button>
                                            ...
                                            <li>
                                                <button class="dropdown-item fw-medium py-2" type="button">Quản lí đặt
                                                    phòng</button>
                                            </li>
                                            <li>
                                                <button
                                                    class="dropdown-item fw-medium border-bottom border-secondary-subtler py-2"
                                                    type="button" style="border-color:blueviolet">Danh sách yêu thích
                                                </button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item py-2" type="button">Quản lí thông tin đặt
                                                    phòng</button>
                                            </li>
                                            <li>
                                                <button
                                                    class="dropdown-item  border-bottom border-secondary-subtler py-2"
                                                    type="button" style="border-color:blueviolet">Quản lí thông tin cá
                                                    nhân
                                                </button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item py-2" type="button">Trung tâm hỗ
                                                    trợ</button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item py-2" type="button">Đăng xuất</button>
                                            </li>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg-end border-1 rounded-4"
                                            style="background-color:#FDE7FB; border-color:blueviolet">
                                            <li>
                                                <button class="dropdown-item fw-medium py-2" type="button">Đăng
                                                    kí</button>
                                            </li>
                                            <li>
                                                <button
                                            ...
                                            <li>
                                                <button class="dropdown-item py-2" type="button">Trang chủ
                                                    AirHome</button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item py-2" type="button">Hỗ trợ</button>
                                            </li>
                                        </ul>
                                    </div>
                            </div>
