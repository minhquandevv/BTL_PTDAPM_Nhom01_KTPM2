        ...
        <div class="col-md-6">
            <div class="card" >
                <div class="card-header text-center fw-bold d-flex  padding-form">
                    <a class="text-dark text-decoration-none" href="/cancelroominfor">
                ...
                <div id="register-body" class="card-body">
                    <form method="POST">
                       ...
                       <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="text-center grey-text text-edit1 mt-2">Bạn có muốn hủy đơn đặt phòng không?</p>
                       </div>
                       <a href="/successcancel">
                       ...
                       <a href="/cancelroominfor">
                            <button type="button" class="btn  w-100 py-3 mt-4 rounded btn-dark text-register text-light fw-500" id="cancel-edit-button">Hủy</button>
