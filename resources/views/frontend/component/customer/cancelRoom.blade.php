<section class="h-100">
    <div class="container mx-auto bg-white h-100">
        <div>
            <h2 class="text-3xl font-bold text-center py-5"> Đơn đã đặt</h2>
        </div>
        <div class="border rounded-4 my-5">
            ...
            <div class="row mx-4 mt-4">
                <div class="col-md-2 my-3">
                    <a href="#">
                        <img class="card-img-top rounded-lg" src="https://img.upanh.tv/2024/02/27/image-8.png" alt="" style="width: 168px; height:138px" />
                    </a>
                </div>
                <div class="col-md-7 align-items-center mt-4">
                    <h3>Mã phòng: MP001</h3>
                    <h3>Tên Phòng: Xe cắm trại/RV </h3>
                    <h3>Giá Phòng: 6.800.000VND</h3>
                </div>
    ...
    <form class="container mx-auto bg-white h-100">
        ...
        <div class="d-flex w-100 mb-5">
            ...
            <div>
                <div>
                    <img class="card-img-top rounded-lg me-5 mb-4" src="https://img.upanh.tv/2024/02/27/image-9.png" alt="" style="width: 280px; height:225px" />
                    <img class="card-img-top rounded-lg mb-4" src="https://img.upanh.tv/2024/02/27/image-11.png" alt="" style="width: 280px; height:225px " />
                </div>
                <div>
                    <img class="card-img-top rounded-lg me-5" src="https://img.upanh.tv/2024/02/27/image-10.png" alt="" style="width: 280px; height:225px" />
                    <img class="card-img-top rounded-lg" src="https://img.upanh.tv/2024/02/27/image-12.png" alt="" style="width: 280px; height:225px" />
                </div>
            </div>
        </div>
        <div class="row py-5">
    ...
    <form class="container mx-auto bg-white h-100">
        <div class="border rounded-4 my-5">
            ...
            <div class="row mx-4 mt-4">
                ...
                <div class="col-3 d-flex justify-content-end align-items-center mb-5 ">
                    <h2 class="text-danger me-5">Đã hủy</h2>
                </div>
            </div>
        </div>
