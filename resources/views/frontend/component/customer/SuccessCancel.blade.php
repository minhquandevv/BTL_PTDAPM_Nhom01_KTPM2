        ...
        <div class="col-md-6">
            <div class="card" >
                <div class="card-header text-center fw-bold d-flex  padding-form">
                    <a class="text-dark text-decoration-none" href="/cancelroomsuccess">
                ...
                <div id="register-body" class="card-body">
                    <form method="POST">
                       ...
                       <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="text-center grey-text text-edit1 mt-2">Hủy đặt phòng thành công!</p>
                       </div>
                       <a href="/cancelroomsuccess">
                            <button type="button" class="btn  w-100 py-3 mt-2 rounded btn-dark text-register text-light fw-500" id="accept-edit-button">Tiếp tục</button>
