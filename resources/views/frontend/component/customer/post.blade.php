<section id="post" class="bg-white py-5 ">
    <form>
        <div class="container mx-auto ">
            <div class="row mx-4 ">
                ...
                <div class="d-flex justify-content-center my-4 py-5">
                    <button href="#" class="btn btn-primary px-5 py-4 bg-danger text-center text-white rounded-4 cursor-pointer border-0" style="background-image: linear-gradient(to right,firebrick 30%, crimson);">
                        <h3>Hiển thị thêm</h3>
                    </button>
                </div>
            </div>
