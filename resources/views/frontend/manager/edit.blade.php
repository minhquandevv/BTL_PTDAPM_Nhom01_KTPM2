...
<div class="container-fluid">
    <div class="row">
        <div class="d-flex justify-content-between align-items-center mx-auto col-12" style="width:1340px ; padding: 40px " >
            ...
            <span style="font-weight: 500; font-size: 25px ; line-height: 20px">Sửa tài khoản </span>
            <a href="/editsuccess" class="text-decoration-none">
            <button type="button" class="btn border 0" style="background:#FF385C linear-gradient(to right,#E61E4D00, #E31C5F80 50%, #D70466 100%); color: white ; width: 240px ; height: 48px">Xác nhận sửa</button>
    ...
    <div class="row ">
        <form class="d-flex justify-content-around border rounded mx-auto col-12" style="width: 1358px ; height: 500px ">
            <div class="align-items-center col-4" style="margin-top: 10vh">
                ...
                <div class="mb-3 row align-items-center">
                    ...
                    <div class="input-group col form-control">
                        <input type="password" class="form-control border-0" id="exampleInputPassword1" oninput="togglePasswordButtonVisibility()">
                ...
                <div class="mb-3 row align-items-center">
                    ...
                    <input type="date" class="form-control col" id="exampleInputPassword1" placeholder="acb">
                </div>
                <div class="mb-3 row align-items-center">
                    ...
                    <div class="form-control col border-0 d-flex" id="gender-profile">
                        <div class="form-check form-check-inline col align-items-center">
                            <input class="form-check-input col" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
