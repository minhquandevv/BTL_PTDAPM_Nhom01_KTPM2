...
<head>
    ...
    <title>Thêm tài khoản thành công</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center fw-bold d-flex  padding-form">
                    <a class="text-dark text-decoration-none" href="/customerservicemanagement">
                    ...
                    <form method="POST">
                        ...
                        <div class="d-flex flex-column align-items-center">
                            <img width="71px" height="70px" src="{{asset('bootstrap/css/patterns/icon-v.svg')}}"
                                 alt="v-image">
                            <p class="text-center grey-text text-edit1 mt-2">Xóa tài khoản thành công!</p>
                        </div>
                        {{-- lỗi css --}}
                        <a href="/customerservicemanagement">
                            <button type="button"
                                    class="btn  w-100 py-3 mt-2 rounded btn-dark text-register text-light fw-500"
                                    id="continue-button-edit">Tiếp tục
                            </button>
