    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card" >
                ...
                <div id="changepassword-body" class="card-body">
                    <p class="text-center grey-text text-5 d-flex justify-content-space-between " style="font-weight: 500 ; font-size: 22px ; line-height: 26px">Vui lòng nhập email hoặc số điện thoại để tìm kiếm tài khoản của bạn <div></div><div></div></p>
                    <div class="border rounded overflow-hidden">

                        <div class="form-floating border-bottom">
                            <input type="text" class="form-control round-0 text-8 border-0" id="floatingPhoneNumber" placeholder="Email/Số điện thoại" >
                            <label for="floatingPhoneNumber">Email/Số điện thoại</label>
                        </div>
                    </div>
