            ...
            <div class="card" >
                ...
                <div id="register-body" class="card-body">
                    <form method="POST">
                        ...
                        <button type="button" class="btn  w-100 py-3 mt-2 rounded btn-danger text-register" id="accept-button">Đồng ý và tiếp tục</button>
...
<script>
    ...
    Validator({
        form: '#register-card',
        rules: [
            Validator.isRequired('#floatingLastName'),
            Validator.isEmail('#floatingEmail'),
