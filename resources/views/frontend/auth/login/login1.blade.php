        ...
        <div class="col-md-6">
            <div class="card" >
                <div class="card-header text-center fw-bold d-flex  padding-form">
                    <a class="text-dark text-decoration-none" href="/register1">
                ...
                <div id="register-body" class="card-body">
                    ...
                    <div class="border rounded overflow-hidden">
                        <div class="form-floating">
                            <input type="text" class="form-control border-0 rounded-0 border-bottom" id="floatingPhoneNumber" placeholder="Số điện thoại">
                   ...
                   {{-- <div class="d-flex justify-content-end pt-2">
                    ...
                    <a href="/bookinghome" class="text-decoration-none">
                        ...
                        <div>
                            ...
                            <a href="/login2" class="text-decoration-none">
