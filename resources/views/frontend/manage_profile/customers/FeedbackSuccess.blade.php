...
<head>
    ...
    <title>Feedback thành công</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="col-md-6">
            <div class="card" >
                <div class="card-header text-center fw-bold d-flex  padding-form">
                    <a class="text-dark text-decoration-none" href="/feedbackform">
                        <i class="fa-solid fa-xmark"></i>
                    </a>
                    
                    <div class=" text-register text-header w-100">Đánh giá của bạn</div>
                </div>
                <div id="register-body" class="card-body">
                    <form method="POST">
                       ...
                       <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="text-center grey-text text-edit1 mt-2">Gửi đánh giá thành công!</p>
                       </div>
                       {{-- lỗi css --}}
