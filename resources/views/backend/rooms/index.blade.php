...
<table class="table">
    ...
    @foreach ($rooms as $room)
        <tr>
            <th scope="row">{{ $room->MaP}}</th>
            <th scope="row">{{ $room->TenPhong}}</th>
            <th scope="row">{{ $room->GioiThieuPhong }}</th>
            <th scope="row">{{ $room->DonGia }}</th>
            <th scope="row">{{ $room->TinhTrang }}</th>
            <th scope="col"><a href="{{ route('rooms.show', $room)}}">
            ...
            <th scope="col"><a href="{{ route('rooms.edit', $room) }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<ul class="pagination">
    ...
    @else
        <li class="page-item">
            <a class="page-link" href="{{ $rooms->previousPageUrl() }}" rel="prev"
    ...
    @if ($rooms->hasMorePages())
        <li class="page-item">
            <a class="page-link" href="{{ $rooms->nextPageUrl() }}" rel="next"
